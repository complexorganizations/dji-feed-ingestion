...
function system-information() {
    ...
    if [ -f /etc/os-release ]; then
        ...
        CURRENT_DISTRO_VERSION_MAJOR=$(echo "${CURRENT_DISTRO_VERSION}" | cut --delimiter="." --fields=1,2)
    fi
}
...
MEDIAMTX_TEST_CONNECTION_ONE="rtsp://PublishAdministrator:PublishPassword@localhost:8554/test_one"
MEDIAMTX_TEST_CONNECTION_TWO="rtsp://PublishAdministrator:PublishPassword@localhost:8554/test_two"
...
YOUTUBE_DLP_TEST_VIDEO_URL_ZERO="https://www.youtube.com/watch?v=Xk24DMOInnQ"
YOUTUBE_DLP_TEST_VIDEO_URL_ONE="https://www.youtube.com/watch?v=LNYm40RmRzs"
YOUTUBE_DLP_TEST_VIDEO_URL_TWO="https://www.youtube.com/watch?v=nQOinVC5j9g"
