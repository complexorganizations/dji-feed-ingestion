...
func init() {
	...
	// Wait for the rtsp server to finish
	...
	for {
		...
		if rtspConnectionCounter == 0 {
			...
			if rtspSeverOneStatus {
				...
				// Forward the data to amazon kinesis
				forwardDataToAWSKinesisVideoStreams(testJSONValue.(*AutoGenerated).Num0.Host, testJSONValue.(*AutoGenerated).Num0.AmazonKinesisVideoStreams.AwsDefaultRegion, testJSONValue.(*AutoGenerated).Num0.AmazonKinesisVideoStreams.AwsAccessKeyID, testJSONValue.(*AutoGenerated).Num0.AmazonKinesisVideoStreams.AwsSecretAccessKey, testJSONValue.(*AutoGenerated).Num0.AmazonKinesisVideoStreams.KinesisStream)
				// Sleep for 1 minute cause rtsp server might still be running
