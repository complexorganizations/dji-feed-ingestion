...
func init() {
	...
	validFormattedString := fmt.Sprintln("vaictl", "-p", testJSONValue.(*AutoGenerated).Num0.GoogleCloudVertexAiVision.ProjectName, "-l", testJSONValue.(*AutoGenerated).Num0.GoogleCloudVertexAiVision.GcpRegion, "-c", "application-cluster-0 --service-endpoint visionai.googleapis.com send rtsp to streams", testJSONValue.(*AutoGenerated).Num0.GoogleCloudVertexAiVision.VertexStreams, "--rtsp-uri", testJSONValue.(*AutoGenerated).Num0.Host)
	for {
