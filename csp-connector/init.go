...
func init() {
	...
	if checkRTSPServerAlive(testJSONValue.(*AutoGenerated).Num0.Host) == false {
		exitTheApplication("The rtsp server is not alive")
	} else {
		fmt.Println("The rtsp server is alive")
	}
}
